...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: {
      ...
      'figma:asset/bfff5ac931bd296881f58b314ebeddff6dce0c23.png': path.resolve(
        __dirname,
        './src/assets/bfff5ac931bd296881f58b314ebeddff6dce0c23.png'
      ),
      'figma:asset/5e25c6c038ecd78f23bb6453b71467354e3bd141.png': path.resolve(
        __dirname,
        './src/assets/5e25c6c038ecd78f23bb6453b71467354e3bd141.png'
      ),
    },
  },
  build: {
